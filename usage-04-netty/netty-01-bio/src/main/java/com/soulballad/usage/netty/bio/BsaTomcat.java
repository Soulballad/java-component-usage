package com.soulballad.usage.netty.bio;
...
public class BsaTomcat {
    private int port = 8080;
    private ServerSocket server;
    private final Map<String, BsaServlet> servletMapping = new HashMap<String, BsaServlet>();
        ...
        try {
            ...
            for (Object k : webxml.keySet()) {
                ...
                if (key.endsWith(".url")) {
                    ...
                    //单实例，多线程
                    BsaServlet obj = (BsaServlet) Class.forName(className).newInstance();
    ...
    private void process(Socket client) throws Exception {
        ...
        BsaRequest request = new BsaRequest(is);
        BsaResponse response = new BsaResponse(os);
