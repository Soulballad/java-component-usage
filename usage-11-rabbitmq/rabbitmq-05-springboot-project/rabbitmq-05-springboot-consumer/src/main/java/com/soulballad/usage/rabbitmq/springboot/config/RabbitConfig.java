package com.soulballad.usage.rabbitmq.springboot.config;
...
public class RabbitConfig {
    @Value("${com.soulballad.usage.rabbitmq.springboot.firstqueue}")
    private String firstQueue;

    @Value("${com.soulballad.usage.rabbitmq.springboot.secondqueue}")
    private String secondQueue;

    @Value("${com.soulballad.usage.rabbitmq.springboot.thirdqueue}")
    private String thirdQueue;

    @Value("${com.soulballad.usage.rabbitmq.springboot.fourthqueue}")
