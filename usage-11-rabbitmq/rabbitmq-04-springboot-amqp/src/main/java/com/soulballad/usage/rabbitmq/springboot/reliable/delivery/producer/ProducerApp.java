package com.soulballad.usage.rabbitmq.springboot.reliable.delivery.producer;
 ...
 * 消息投递的可靠性保证
 */
@ComponentScan(basePackages = "com.soulballad.usage.rabbitmq.springboot.reliable.delivery.producer")
