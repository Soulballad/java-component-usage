package com.soulballad.usage.rabbitmq.springboot.reliable.receive.producer;
 ...
 * 消息消费的可靠性保证——ACK
 */
@ComponentScan(basePackages = "com.soulballad.usage.rabbitmq.springboot.reliable.receive.producer")
