package com.soulballad.usage.rabbitmq.springboot.ttl;
...
@ComponentScan(basePackages = "com.rabbitmq.ttl")
public class TtlSender {
    ...
    public static void main(String[] args) {
        ...
        rabbitTemplate.send("GP_TTL_EXCHANGE", "rabbitmq.ttl", message);

        // 随队列的过期属性过期，单位ms
        rabbitTemplate.convertAndSend("GP_TTL_EXCHANGE", "rabbitmq.ttl", "这条消息");
    }
}
