package com.soulballad.usage.p4.enumtype;
...
public class EnumSingletonReflectAttack {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Constructor<EnumSingleton> constructor1 =
            // enumClass.getDeclaredConstructor(null);
            // constructor1.setAccessible(true);
            // // java.lang.NoSuchMethodException: EnumSingleton.<init>()
            // // 没有无参构造方法
