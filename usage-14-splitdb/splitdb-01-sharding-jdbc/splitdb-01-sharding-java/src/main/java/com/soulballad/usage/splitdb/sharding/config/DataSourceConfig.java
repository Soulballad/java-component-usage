package com.soulballad.usage.splitdb.sharding.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.soulballad.usage.splitdb.sharding.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
