package com.soulballad.usage.schdeule.ejob.simple;
...
public class SimpleJobTest {
    ...
    public static void main(String[] args) {
        // ZK注册中心
        CoordinatorRegistryCenter regCenter = new ZookeeperRegistryCenter(new ZookeeperConfiguration("172.16.11.125:2181", "gupao-ejob-standalone"));
        regCenter.init();

        // 数据源，使用DBCP
        BasicDataSource dataSource = new BasicDataSource();
        dataSource.setDriverClassName("com.mysql.jdbc.Driver");
        dataSource.setUrl("jdbc:mysql://172.16.11.125:3306/elastic_job_log");
