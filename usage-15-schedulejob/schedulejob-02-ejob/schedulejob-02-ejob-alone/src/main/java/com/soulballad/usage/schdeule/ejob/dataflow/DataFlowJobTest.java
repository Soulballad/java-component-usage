package com.soulballad.usage.schdeule.ejob.dataflow;
...
public class DataFlowJobTest {
    ...
    public static void main(String[] args) {
        // ZK注册中心
        CoordinatorRegistryCenter regCenter = new ZookeeperRegistryCenter(new ZookeeperConfiguration("172.16.11.125:2181", "gupao-stand-data"));
        regCenter.init();
